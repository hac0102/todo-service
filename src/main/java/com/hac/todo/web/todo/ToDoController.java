...
public class ToDoController {
    ...
    @PutMapping("/api/v1/todoDetail")
    public ResponseEntity<?> updateTodoDetail(@RequestBody TodoDetailRequestDto todoDetailRequestDto) {
        int affectRow = todoService.updateTodoDetail(todoDetailRequestDto);
        return new ResponseEntity<>(HttpStatus.OK);
    }
}
